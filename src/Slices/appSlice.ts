...
const initialState: AppStateInterface = {
    markers: (markersFromJson as Array<MarkerInterface>),
...
export const selectSkillBookMarkers = (state: RootState): AppStateInterface['markers'] => state.app.markers.filter((marker) => marker.type === typeMap.SkillBook);
export const selectSnowGlobeMarkers = (state: RootState): AppStateInterface['markers'] => state.app.markers.filter((marker) => marker.type === typeMap.SnowGlobe);
